...
void DoStudent::menu()
{
    ...
    do {//最外层循环
        ...
        {char name[20]; int number; double yuwen, shuxue, waiyu; char c;
        ...
        case '3':                    //修改数据
        {char name[20]; int number; double yuwen, shuxue, waiyu;
        char na[20]; int nu; double y, sh, w; char c;
        ...
        do {
            ...
            while (!in.eof())
            {
                ...
                {
                    flag = 1;
                    cout << "您要查询的学生:" << name << "的成绩是: " << endl << endl;
        ...
        case'6':            //信息删除
        {char name[20], na[20]; int number; double yuwen, shuxue, waiyu; char c;
        int k;
        do
        {
            int n = 0; int flag = 0;
            ...
            while (!in.eof())
            {
                in >> name >> number >> yuwen >> shuxue >> waiyu;
                s[n] = new Student
                (name, number, yuwen, shuxue, waiyu);
                stu[n] = *s[n];
                delete s[n];
                n++;
            }
