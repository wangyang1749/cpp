    ...
    if (input)
    {
        ...
        while (getline(input, line))
        {
            ...
            if (line[0] == 'C')
            {
                ...
                // cout<<dv[0]<<endl;
                shared_ptr<Circle> circle(new Circle(Point(dv[0], dv[1]), dv[2]));
            ...
            else if (line[0] == 'P')
            {
                ...
                vector<Edge> edges;
                for (vector<double> i : vv)
                {
                    edges.push_back(Edge(Point(i[0], i[1]), Point(i[2], i[3])));
                }
                shared_ptr<Polygon> polygon(new Polygon(edges));
...
int main()
{
    string filename = "/home/wy/Documents/cpp/project2/shapes.txt";
